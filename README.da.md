...
<p align="center">
  ...
  Den vurderer, rangerer og skriver udkast. <strong>Den sender aldrig noget: det gør du.</strong> Open source, lokalt, dit.
</p>

<p align="center">
  <a href="https://x.com/santifer/status/2041403685696053741"><img src="docs/demo.gif" alt="career-ops-pipeline: opslag med score, 219 markeret som søg ikke, derefter én fuld vurdering" width="800"></a>
</p>

<p align="center"><sub>Et øjebliksbillede midt i jobsøgningen: pipelinen, derefter ét opslag åbnet og vurderet fra ende til anden.</sub></p>

<p align="center"><strong>Ud af 740 opslag var 68 værd at søge. 12 samtaler. 1 tilbud.</strong></p>
<p align="center"><sub>Én jobsøgning, forfatterens, 2026. Tallet der betyder noget er frasorteringen, ikke mængden. Alle tal i <a href="https://santifer.io/career-ops-system">casestudiet</a>.</sub></p>

<p align="center"><sub>Sender aldrig, mailer aldrig, ringer aldrig hjem: <a href="#hvad-career-ops-ikke-gør">hvad den ikke gør</a> · kører i den AI-CLI du allerede bruger, <a href="docs/RUNNING_ON_A_BUDGET.md">gratis og lokale modeller inkluderet</a>.</sub></p>
...
<p align="center">
  <a href="HIRED.md"><img src="https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fraw.githubusercontent.com%2Fsantifer%2Fcareer-ops%2Fmain%2Fdocs%2Fhired-count.json&query=%24.count&label=%F0%9F%8E%89%20HIRED%20WITH%20CAREER-OPS&suffix=%20verified&color=2ea44f&style=for-the-badge&labelColor=2b3137" alt="Ansat med career-ops: verificeret antal"></a>
</p>

<p align="center"><sub>Fik du dit? <a href="https://github.com/career-ops-hq/career-ops/issues/new?template=i-got-hired.yml">Del det →</a> · dit kort viser en, der er midt i søgningen, at der findes en vej ud.</sub></p>

<p align="center">
  <a href="HIRED.md"><img src="docs/hired-wall.svg" alt="De tre seneste ansættelseshistorier" width="800"></a>
</p>

<p align="center"><sub>Hvert tal er en offentlig historie, du kan <a href="HIRED.md">efterprøve →</a> · hver eneste begyndte, hvor du er nu.</sub></p>

<p align="center"><sub>OMTALT I</sub></p>
...
career-ops ([career-ops.org](https://career-ops.org), også kendt som **careerops**) er en open source AI-jobsøgning, der kører lokalt i enhver AI-kodnings-CLI: den vurderer opslag, tilpasser dit CV og holder styr på hver ansøgning, og du har altid det sidste ord. I stedet for manuelt at holde styr på ansøgninger i et regneark får du en AI-drevet pipeline, der:

- **Vurderer opslag** i en struktureret rapport: blok A til H, med en samlet score fra 1 til 5, der nås ved en helhedsvurdering på tværs af fem dimensioner frem for en regneformel. Blok B's kolonne med vigtighed pr. krav og blok G's vurdering af opslagets troværdighed er begge separate, scoreneutrale signaler, der aldrig påvirker scoren; blok H skrives kun fra 4,5 og op
- **Genererer skræddersyede PDF'er**: ATS-optimerede CV'er tilpasset hver jobbeskrivelse
- **Scanner portaler** automatisk (Greenhouse, Ashby, Lever, virksomhedssider)
- **Behandler i batch**: vurder 10+ opslag parallelt med underagenter
- **Holder styr på alt** i én kilde til sandhed med integritetstjek
- **Researcher virksomheder og finder den rette person at kontakte**: ansøgninger sætter dig i køen; research giver dig en samtale

> **Vigtigt: Det her er IKKE et spray-and-pray-værktøj.** career-ops er et filter: det hjælper dig med at finde de få opslag, der er din tid værd, ud af hundredvis. Systemet fraråder kraftigt at søge noget som helst med en score under 4,0/5. Din tid er værdifuld, og det er rekrutterens også. Gennemgå altid, før du sender.

career-ops er agentisk: den AI-kodnings-CLI, du vælger, navigerer karrieresider med Playwright, vurderer match ved at ræsonnere over dit CV i forhold til jobbeskrivelsen (ikke nøgleordsmatch) og tilpasser dit CV til hvert opslag.

> **Bemærk: De første vurderinger bliver ikke gode.** Systemet kender dig ikke endnu. Giv det kontekst: dit CV, din karrierehistorie, dine dokumenterede resultater, dine præferencer, hvad du er god til, hvad du vil undgå. Jo mere du fodrer det, jo bedre bliver det. Tænk på det som onboarding af en ny rekrutterer: den første uge skal de lære dig at kende, og derefter bliver de uvurderlige.

Bygget af en, der brugte det til at vurdere 740 jobopslag, søge 68 og lande en stilling som Head of Applied AI. [Læs hele casestudiet](https://santifer.io/career-ops-system).

## Hvad career-ops ikke gør

- **Sender en ansøgning.** Den forbereder svarene; du åbner formularen og klikker Send. Scriptet laver aldrig et POST (`prepare-application.mjs`).
...
career-ops er den første referenceimplementering af [CareerOps-manifestet](https://career-ops.org/manifesto?utm_source=readme). læs det. hvis det siger, hvad du tror på, så skriv under. din underskrift bliver et commit.
...
**Hvad er career-ops?**
career-ops er en open source AI-jobsøgning, der kører lokalt i din AI-kodnings-CLI (Claude Code, Codex, OpenCode og andre) og overlader hver beslutning til dig. Den vurderer jobopslag mod dit CV, genererer ATS-tilpassede PDF'er, finder den rette person at kontakte og holder styr på alt ét sted: du har altid det sidste ord. Den er den første referenceimplementering af CareerOps-manifestet. Mere på [career-ops.org](https://career-ops.org).
...
<p align="center">
  <sub>Kører også i enhver CLI efter agent-skill-standarden. Se <a href="docs/SUPPORTED_CLIS.md">Understøttede CLI'er</a>.</sub><br>
